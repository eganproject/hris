                ...
                @forelse ($users as $user)
                    ...
                    <form method="POST" action="{{ route('access-control.user-scope.update', $user) }}" class="grid grid-cols-1 gap-5 px-5 py-5 lg:grid-cols-[200px_1fr_1fr_1fr_auto]">
                        ...
                        <div class="min-w-0">
                            ...
                            {{-- Cakupan khusus untuk halaman-halaman yang dipersempit ke garis
                            ...
                            <div class="mt-3 rounded-md border border-gray-200 bg-gray-50 p-2.5">
                                <p class="text-xs font-medium text-gray-700">Cakupan di Absensi Harian, Jadwal Kerja, Cuti, Lembur, Koreksi &amp; Laporan</p>
