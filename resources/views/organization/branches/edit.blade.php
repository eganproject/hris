<x-layouts.app title="Edit Lokasi - {{ config('app.name', 'HRIS') }}" heading="Edit Lokasi">
    <div class="mx-auto max-w-4xl space-y-6">
        <div class="flex items-center justify-between gap-4">
            <h1 class="text-2xl font-semibold text-gray-950">Edit Lokasi Kerja</h1>
        ...
        <form method="POST" action="{{ route('organization.branches.update', $branch) }}" class="space-y-6">
            @csrf
            @method('PUT')
