<x-layouts.app title="Tambah Tempat Penyimpanan - {{ config('app.name', 'HRIS') }}" heading="Tambah Tempat Penyimpanan">
    <div class="mx-auto max-w-4xl space-y-6">
        <div class="flex items-center justify-between gap-4">
            <h1 class="text-2xl font-semibold text-gray-950">Tambah Tempat Penyimpanan</h1>
        ...
        <form method="POST" action="{{ route('assets.storage-locations.store') }}" class="space-y-6">
            @csrf
