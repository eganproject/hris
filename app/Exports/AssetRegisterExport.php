 ...
 * rekap per sumbu untuk rapat, ringkasan per nama untuk melihat barang apa yang
 * menumpuk, daftar lengkap untuk penelusuran dan pivot sendiri, dan lembar
 * keterangan supaya berkas yang beredar lewat surel tidak kehilangan konteks
 * filternya.
 *
 * "Ringkas per Nama" dan "Register Aset" sengaja berdampingan, bukan salah satunya
...
class AssetRegisterExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        return [
            ...
            new AssetRegisterNameSheet($this->names, $this->summary),
