...
class AssetRegisterInfoSheet implements FromArray, ShouldAutoSize, WithEvents, WithTitle
{
    ...
    public function array(): array
    {
        ...
        $rows[] = ['Ringkas per Merek vs Register Aset', 'Dua bentuk dari data yang sama, sengaja dua-duanya ada. "Ringkas per Merek" menggabungkan aset menjadi satu baris per pasangan merek dan model — untuk membaca cepat barang apa yang menumpuk. "Register Aset" tetap satu baris per unit — untuk menelusuri unit tertentu dan untuk diolah sendiri dengan filter atau pivot. Totalnya selalu sama.'];
        $rows[] = ['Penggabungan merek & model', 'Digabung bila tulisannya sama setelah besar-kecil huruf dan spasi tepinya diabaikan, jadi "Apple" dan "APPLE" terhitung satu. Kolom Variasi Ejaan menandai model yang perlu dirapikan di master aset.'];
        $rows[] = ['Tanpa Merek / Tanpa Model', 'Kolom Merek dan Model boleh kosong di master aset. Yang kosong dikumpulkan menjadi kelompok tersendiri di urutan paling bawah, bukan disembunyikan — besarnya kelompok itu adalah ukuran berapa banyak data yang masih perlu dilengkapi.'];
