...
class AssetRegisterInfoSheet implements FromArray, ShouldAutoSize, WithEvents, WithTitle
{
    ...
    public function array(): array
    {
        ...
        $rows[] = ['Ringkas per Jenis vs Register Aset', 'Dua bentuk dari data yang sama, sengaja dua-duanya ada. "Ringkas per Jenis" menggabungkan aset menjadi satu baris per pasangan jenis/merek dan tipe/varian — untuk membaca cepat barang apa yang menumpuk. "Register Aset" tetap satu baris per unit — untuk menelusuri unit tertentu dan untuk diolah sendiri dengan filter atau pivot. Totalnya selalu sama.'];
        $rows[] = ['Penggabungan jenis & tipe', 'Digabung bila tulisannya sama setelah besar-kecil huruf dan spasi tepinya diabaikan, jadi "Iphone" dan "IPHONE" terhitung satu. Kolom Variasi Ejaan menandai tipe yang perlu dirapikan di master aset.'];
        $rows[] = ['Tanpa Jenis / Tanpa Tipe', 'Kolom Jenis / Merek dan Tipe / Varian boleh kosong di master aset. Yang kosong dikumpulkan menjadi kelompok tersendiri di urutan paling bawah, bukan disembunyikan — besarnya kelompok itu adalah ukuran berapa banyak data yang masih perlu dilengkapi.'];
